 ...
 * @version 1.0
 */
L5.Texture2D                   = function (
    format, dimension0, dimension1, numLevels, usage
) {
...
L5.Texture2D.prototype.generateMipmaps = function () {
    ...
    if (this.numLevels != maxLevels) {
        ...
        newData.set (this.data.subarray (0, this.numLevelBytes[ 0 ]), 0);
        delete this.data;
        this.data   = newData;
    }
 ...
 * @protected
 */
L5.Texture2D.prototype.generateNextMipmap = function (
    width, height, texels,
    ...
    // 转换纹理元素到32bitRGBA
    L5.Texture.COLOR_FROM_FUNC[ this.format ] (numTexels, this.data.subarray (texels, texels + numTexels * pixelSize), rgba);
