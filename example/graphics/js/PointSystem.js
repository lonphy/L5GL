...
document.querySelector('canvas').addEventListener('click', function(){
    ...
    let fullscreenElement = document.fullscreenElement || document.webkitFullscreenElement || document.mozFullscreenElement;
    let exitFullscreenElement = document.exitFullscreen || document.webkitExitFullscreen || document.mozExitFullscreen;
    let requestFullScreen = this.RequestFullScreen || this.webkitRequestFullScreen;

    if (fullscreenElement) {
        exitFullscreenElement.call(document);
    } else {
...
class PointSystem extends L5.Application3D{
    ...
    createScene () {
        ...
        var vbo = new L5.VertexBuffer(10240, stride, L5.Buffer.BU_DYNAMIC);
        var vba = new L5.VertexBufferAccessor(format, vbo);
        var i, l = vba.numVertices;
