...
L5.GLTexture2D = function (
    ...
    this.previousTexture = gl.getTexParameter (gl.TEXTURE_BINDING_2D);
 ...
 */
L5.GLTexture2D.prototype.enable  = function (
 ...
 * @param textureUnit {number}
 */
L5.GLTexture2D.prototype.disable = function (
    renderer, textureUnit
) {
    var gl = renderer.gl;
    gl.activeTexture (gl.TEXTURE0 + textureUnit);
