class Texture2DTest extends L5.Application3D {
    constructor() {
    ...
    createScene() {
        ...
        var std = new L5.StandardMesh(format, 0, false);
    ...
    createGround() {
        ...
        ++this.loadWait;
        L5.XhrTask('wmtf/l5kx.l5tf').then(L5.Texture2D.unpack).then(texture=>{
...
L5.runApplication(Texture2DTest);