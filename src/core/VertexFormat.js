 ...
 */
L5.VertexFormat.create = function (
    numAttributes    /*, usage1, type1, usageIndex1, usage2,...*/
) {
 ...
 */
L5.VertexFormat.prototype.setAttribute = function (
    attribute, streamIndex, offset, type, usage, usageIndex
) {
 ...
 */
L5.VertexFormat.prototype.getAttribute     = function (
    attribute
) {
 ...
 */
L5.VertexFormat.prototype.setStride        = function (
    stride
) {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getIndex         = function (
    usage, usageIndex
) {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getStreamIndex   = function (
    attribute
) {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getOffset        = function (
    attribute
) {
    if (0 <= attribute && attribute < this.numAttributes) {
 ...
 */
L5.VertexFormat.prototype.getAttributeType = function (
    attribute
) {
    if (0 <= attribute && attribute < this.numAttributes) {
...
L5.VertexFormat.prototype.getAttributeUsage = function (
    attribute
) {
    if (0 <= attribute && attribute < this.numAttributes) {
...
L5.VertexFormat.prototype.getUsageIndex = function(
    attribute
) {
    if (0 <= attribute && attribute < this.numAttributes)
    {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getComponentSize = function (
    type
) {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getNumComponents = function (
    type
) {
 ...
 * @returns {number}
 */
L5.VertexFormat.prototype.getTypeSize = function(
    type
) {
 ...
 * @constructor
 */
L5.VertexFormat.Element = function (
    streamIndex, offset, type, usage, usageIndex
) {
