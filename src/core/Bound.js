 ...
 * @returns {L5.Bound}
 */
L5.Bound.prototype.copy = function(
    bound
){
 ...
 * @returns {number}
 */
L5.Bound.prototype.whichSide = function (
    plane
) {
...
L5.Bound.prototype.growToContain = function (bound) {
    ...
    var centerDiff = bound.center - this.center;
 ...
 * @param bound {L5.Bound}
 */
L5.Bound.prototype.transformBy = function(
        transform, bound
) {
    bound.center = transform*this.center;
 ...
 */
L5.Bound.prototype.computeFromData = function(
    numElements, stride, data
) {
    ...
    for (i = 0; i < numElements; ++i)
    {
        ...
        // todo: fix arraybuffer
        position = data.getFloat32(i*stride);
        sum[0] += position.x;
        sum[1] += position.y;
        sum[2] += position.z;
    }
 ...
 * @returns {boolean}
 */
L5.Bound.prototype.testIntersection = function (
 ...
 * @returns {boolean}
 */
L5.Bound.prototype.testIntersection1 = function (
    bound
){
 ...
 * @returns {boolean}
 */
L5.Bound.prototype.testIntersection2 = function (
    bound, tmax, velocity0, velocity1
){
    if (bound.radius === 0 || this.radius === 0)
    {
        // One of the bounds is invalid and cannot be intersected.
