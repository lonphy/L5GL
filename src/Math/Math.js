 ...
 * @returns {number}
 */
L5.Math.log2OfPowerOfTwo = function(
    powerOfTwo
) {
 ...
 * @returns {number}
 */
L5.Math.invSqrt = function (
    value
) {
    if (value !== 0)
    {
        return 1/this.sqrt(value);
    }
...
* @returns {number}
*/
L5.Math.intervalRandom = function (
    min,max
) {
 ...
 * @returns {number}
 */
L5.Math.fastInvSin0 = function (
    value
) {
    var root = this.sqrt(this.abs(1 - value));
